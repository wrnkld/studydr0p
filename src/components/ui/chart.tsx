  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        ref={ref}
        className={cn(
          // No default aspect ratio — callers control height via class or style.
          // Without this, recharts' ResponsiveContainer fights an enforced 16:9
          // box and you get half-rendered charts on narrow viewports.
