          ...
          <ul className="space-y-3">
            {cards.map((c, i) => (
              <li key={c.id} className="flex items-center gap-2">
                ...
                />
                <Button variant="ghost" size="icon" onClick={() = className="text-muted-foreground hover:bg-destructive/10 hover:text-destructive"> removeCard(c.id)}>
              ...
              {categories.map((c, i) => (
                <li key={c.id} className="flex items-center gap-2">
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    onClick={() = className="text-muted-foreground hover:bg-destructive/10 hover:text-destructive"> removeCategory(c.id)}
                  >
                    <Trash2 className="h-4 w-4" strokeWidth={1.5} />
                  </Button>
                </li>
